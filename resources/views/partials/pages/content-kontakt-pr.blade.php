<div class="row">
  <div class="col-12">
    <h2
      class="text-center big"><?= _e( "Fragen zu unseren Karrieremöglichkeiten? Beantworten wir gerne!", "sanlucar" ); ?></h2>
  </div>
</div>
{{--1--}}
<div class="row">
  <div class="col-12"><h2><?= _e( "Pressekontakt Deutschland – SanLucar Fruit", "sanlucar" ); ?></h2></div>
</div>
<div class="row">
...
{{--2--}}
<div class="row mt-5">
  <div class="col-12"><h2><?= _e( "Pressekontakt Österreich– SanLucar Fruit", "sanlucar" ); ?></h2></div>
</div>
<div class="row">
  <div class="col-12 col-md-2 mt-3">
    <img src="<?=  get_template_directory_uri() . '/../dist/images/icons/profile.png';?>" alt="">
...
{{--3--}}
<div class="row mt-5">
  <div class="col-12"><h2><?= _e( "Pressekontakt International – SanLucar Fruit", "sanlucar" ); ?></h2></div>
</div>
<div class="row">
  <div class="col-12 col-md-2 mt-3">
    <img src="<?=  get_template_directory_uri() . '/../dist/images/icons/profile.png';?>" alt="">
